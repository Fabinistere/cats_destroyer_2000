...
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hdac403b837d2b372(a: number, b: number): void;
export function closure6275_externref_shim(a: number, b: number, c: number): void;
export function closure6272_externref_shim(a: number, b: number, c: number, d: number): void;
export function _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h71ee6428592eebb2(a: number, b: number): void;
export function closure75535_externref_shim(a: number, b: number, c: number): void;
